...
export const AVAILABLE_MODELS = [
  ...
  "gpt-5-nano", // lowest cost smaller model
  "gpt-4.1-mini", // smaller GPT-4 series model
  "gpt-4.1-nano", // even smaller variant
  "o4-mini", // smaller reasoning model
  "o3-mini", // legacy mini reasoning model
  "codex-mini-latest", // for coding-specific tasks (small)
] as const;
...
export const OpenAiDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>ChatGPT Configuration</DialogTitle>
          <DialogDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The ChatGPT Model use for the execution.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
